...
// This is pretty standard Codable stuff except one thing: Identifiable and var id. In SwiftUI in order to iterate freely through an array of objects it has to have some sort of identifier this is where Identifiable come in to play.
...
// We're passing a company object in every view so this is a dummy object for the preview.
